...
// Delivery Notes public access / fallback
Route::get('/delivery-notes/kpis', [DeliveryNoteController::class, 'kpis']);
...
Route::put('/delivery-notes/{id}/status', [DeliveryNoteController::class, 'updateStatus']);
